	...
	function display_messages($flush = false) 
	{
		if(isset($_SESSION['quipp']['feedback']) && count($_SESSION['quipp']['feedback']) > 0) {
			...
			foreach($_SESSION['quipp']['feedback'] as $messageContent) {
				...
				case 1: $iconImagePath = "/admin/js/growl/img/confirm_24.png"; //good 
				break;
				case 2: $iconImagePath = "/admin/js/growl/img/cancel_24.png"; //bad 
				break;
				default: $iconImagePath = "/admin/js/growl/img/info_24.png"; //info
				break;
				}
				print "
				$.gritter.add({
