 ...
 * @param string print|var_dump|mixed
 */
function yell()
{
    $log_file = Quipp()->config('yell_log');
 ...
 * @param bool Strip the string of HTML tags
 * @param bool Encode the string for HTML display
 * @return string
 */
 ...
 * input paramaters
 */
function pagination($total, $current = 1, $url = '/?page=', $display, $showAll = true)
{
...
function validate_form($formData = false)
{
    ...
    Quipp()->debug()->add('validate_form being called');
...
function tinyMCE($id, $theme)
{
    ...
    if($theme == "standard") {
        $buttons = 'theme_advanced_buttons1 : "undo,redo,code,|,link,unlink,anchor,image,|,bold,italic,underline,strikethrough,|,justifyleft,justifycenter,justifyright,justifyfull,|,bullist,numlist,|,formatselect",
            theme_advanced_buttons2 : "pastetext,pasteword,|,tablecontrols,|,sub,sup",
            theme_advanced_buttons3 : "",
            theme_advanced_buttons4 : "",';
    ...
    $return .=  ' script_url : "/js/tiny_mce/tiny_mce.js",
