...
$_SESSION['tinybrowser']['path']['image'] = '/uploads/img/'; // Image files location - also creates a '_thumbs' subdirectory within this path to hold the image thumbnails
...
$_SESSION['tinybrowser']['path']['file']  = '/uploads/'; // Other files location
...
// size format: b, kb, mb
$_SESSION['tinybrowser']['maxsize']['image'] =  '10mb';// Image file maximum size 
...
$_SESSION['tinybrowser']['max_quota']    = '2gb'; // should be adjusted to your needs
