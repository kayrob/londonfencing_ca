				...
				<?php
					...
					if($db->valid($pQ)){
						while ($pRS = $db->fetch_array($pQ)) {
							...
							print "<td style='padding:0 0 0 10px'><img src=\"/uploads/banners/".$pRS['photo']."\" alt=\"\" width=\"120px\" height=\"70px\" /></td>";
							print "<td style='padding:0 0 0 10px'><img src=\"/uploads/banners/".(trim($pRS['overlay']) == '' ?'smilingLady.png':$pRS['overlay'])."\" alt=\"\" width=\"50px\" height=\"70px\" /></td>";
							print "</tr>"; 
						} 
					}
