...
<?php
		foreach ($photos as $pList){
			...
			$end = (count($album) > 5)?6:count($album);
                echo '<a href="/gallery?t='.$tagID.'">
				<img src="/bin/media/med/'.$album[0]["img"].'" alt="" width="126px" height="126px" title="'.$album[0]["title"].'"/></a>';

			echo '<p class="btnStyle" id="p_more_'.str_replace(" ","_",$tag).'"><a href="/gallery?t='.$tagID.'">Full Gallery</a></p>';
                        echo '</li>';
			}
		}
?>
