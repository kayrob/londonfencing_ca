...
<form action="<?php print $_SERVER['REQUEST_URI']; ?>" method="post" id="begIntRegForm">
    ...
    <div>
        ...
        <input type="text" name="RQvalPOSTpostalCode" id="RQvalPOSTpostalCode"  value = "<?php echo $post["RQvalPOSTpostalCode"];?>" />
    </div>
    <div>
...
?>
    <div>
        ...
        <input type="text" name="OPvalALPHparentName" id="OPvalALPHparentName"  value = "<?php echo $post["OPvalALPHparentName"];?>" /><small>If Participant is less than 18 years old</small>
    </div>
    <div>
