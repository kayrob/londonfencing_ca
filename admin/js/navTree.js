        ...
        "types": {
            ...
            "types": {
                ...
                "default": {
                    ...
                    "icon": {
                        "image": "/admin/img/admin/jstreeExtras/file.png"
                    }
                },
                // The `folder` type
                "outbound": {
                    ...
                    "icon": {
                        "image": "/admin/img/admin/jstreeExtras/log_in_16.png"
                    }
                },
                ...
                "outboundinactive": {
                    ...
                    "valid_children": ["default", "page", "pageinactive", "pageprotected", "outbound", "outboundinactive", "homepageprotected", "homepage"],
                    "icon": {
                        "image": "/admin/img/admin/jstreeExtras/log_in_16_inactive.png"
                    }
                },
                ...
                "homepage": {
                    ...
                    "valid_children": ["default", "page", "pageinactive", "pageprotected", "outbound", "outboundinactive", "homepageprotected", "homepage"],
                    "icon": {
                        "image": "/admin/img/admin/jstreeExtras/view_site_16.png"
                    }
                },
                ...
                "page": {
                    ...
                    "valid_children": ["default", "page", "pageinactive", "pageprotected", "outbound", "outboundinactive", "homepageprotected", "homepage"],
                    "icon": {
                        "image": "/admin/img/admin/jstreeExtras/view_site_blue_16.png"
                    }
                },
                ...
                "pageinactive": {
                    ...
                    "valid_children": ["default", "page", "pageinactive", "pageprotected", "outbound", "outboundinactive", "homepageprotected", "homepage"],
                    "icon": {
                        "image": "/admin/img/admin/jstreeExtras/view_site_inactive_16.png"
                    }
                },
                // The `folder` type
                "bucket": {
                    ...
                    "valid_children": ["default", "page", "pageinactive", "pageprotected", "outbound", "outboundinactive", "homepageprotected", "homepage"],
                    "icon": {
                        "image": "/admin/img/admin/jstreeExtras/template_16.png"
                    },
                ...
                "instance": {
                    ...
                    "icon": {
                        "image": "/admin/img/admin/jstreeExtras/network_16.png"
                    },
                    // those options prevent the functions with the same name to be used on the `drive` type nodes
                    // internally the `before` event is used
                    "start_drag": false,
                ...
                "site": {
                    ...
                    "icon": {
                        "image": "/admin/img/admin/jstreeExtras/web_16.png"
                    },
                    // those options prevent the functions with the same name to be used on the `drive` type nodes
                    // internally the `before` event is used
                    "start_drag": false,
